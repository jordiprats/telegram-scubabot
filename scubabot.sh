  ...
  then
    ...
    if [ "${VERBOSE}" -eq 1 ];
          then
                  ...
                  if [ "$DEBUG" -eq 1 ]; then echo "NO ENVIAT a telegram ${CHATID}:"; fi;
          fi
  fi

  if [ "$DEBUG" -eq 1 ]; then echo "chatid: ${CHATID} ${MESSAGE}"; fi;
